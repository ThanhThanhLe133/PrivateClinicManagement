...
public class AdminMainFormController {
    ...
    @FXML private TableColumn<DoctorFullData, String> doctors_col_confirm;
    ...
    private void loadAdminProfile() {
        String checkUserSQL = "SELECT name, username, email, gender, FROM user_account WHERE username = ?";
